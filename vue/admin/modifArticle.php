...
<html class="no-js" lang="">
   ...
   <body>
      ...
      <div id="right-panel" class="right-panel">
         ...
         <form action="modifArticle" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card">
                           ...
                           <div class="card-body card-block">
                              ...
                              <div class="form-group">
                                 <label for="idCategorie" class=" form-control-label">Catégorie</label>
                                 <select class="ht__select" id="idCategorie" name="idCategorie">
                                    <option value=""></option>
                              ...
                              <input type="hidden" name="article" value="<?=isset($article)?htmlspecialchars($article->getId()):'' ?>"/>
                              <button id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
                              <span id="payment-button-amount">Modifier l'article</span>
                              </button>
                           </div>
                        </div>
                     </div>
