        ...
        <div class="ht__bradcaump__area" style="background: rgba(0, 0, 0, 0) url(images/bg/4.jpg) no-repeat scroll center center / cover ;">
            <div class="ht__bradcaump__wrap">
                <div class="container">
                    ...
                    <br/>
                    <div class="row">
                        <h2 class='title_line text-success'><?=isset($_GET['resultat'])?htmlspecialchars($_GET['resultat']):'' ?></h2>
                    </div> 
                </div>
            </div>
        </div>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="table-content table-responsive">
                                <table>
                                    <thead>
                                        <tr>
                                            <th class="product-price">Voir</th>
                                            <th class="product-price">Id</th>
                                            <th class="product-price">Coût</th>
                                            <th class="product-name">Date commande</th>
                                            <th class="product-price">Statut</th>
                                            <th class="product-price">Payée</th>
                                            <th class="product-name">Methode de paiement</th>
                                            <th class="product-name">Adresse</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?$i=0;?>
                                        <?if(isset($listeCommandes) && !empty($listeCommandes)){
                                            foreach ($listeCommandes as $commande) {?>
                                                <tr>
                                                    <td class="product-remove"><a href="historiqueCommandes?idCommande=<?=htmlspecialchars($commande->getId()) ?>"><i class="icon-eye icons"></i></a></td>
                                                    <td class="product-price"><?=htmlspecialchars($commande->getId())?></td>
                                                    <td class="product-price"><span class="amount"><?=htmlspecialchars($commande->getCout())?> FCFA</span></td>
                                                    <td class="product-price"><span class="amount"><?=htmlspecialchars($commande->getDateCommande()->format('l d-m-Y à H:i:s'))?></span></td>
                                                    <td class="product-price"><span class="amount"><?=htmlspecialchars($commande->getStatut())?></span></td>
                                                    <td class="product-price"><span class="amount"><?=htmlspecialchars($commande->isPaye()?'OUI':'NON')?></span></td>
                                                    <td class="product-price"><span class="amount"><?=htmlspecialchars($commande->getMethodePaiement()=='orangeMoney'?'Orange Money':'')?> <?=htmlspecialchars($commande->getMethodePaiement()=='wave'?'Wave':'')?> <?=htmlspecialchars($commande->getMethodePaiement()=='espece'?'En espèce':'')?></span></td>
                                                    <td class="product-price"><span><?=htmlspecialchars($commande->getAdresse()->getDescription())?></span>
                                                        <ul  class="pro__prize">
                                                            <li><?=htmlspecialchars($commande->getAdresse()->getVille())?></li>,
                                                            <li><?=htmlspecialchars($commande->getAdresse()->getRegion())?></li>
                                                        </ul>
                                                    </td>
                                                </tr>
                                            <?}
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="buttons-cart--inner">
                                        <div class="buttons-cart">
                                            <a href="accueil">Continuer le shopping</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
