        ...
        <div class="ht__bradcaump__area" style="background: rgba(0, 0, 0, 0) url(images/bg/4.jpg) no-repeat scroll center center / cover ;">
            <div class="ht__bradcaump__wrap">
                <div class="container">
                        ...
                        <div class="col-xs-12">
                            <div class="bradcaump__inner">
                                <nav class="bradcaump-inner">
                                  ...
                                  <a class="breadcrumb-item" href="parametrage">Paramétrage</a>
                                  <span class="brd-separetor"><i class="zmdi zmdi-chevron-right"></i></span>
                                  <span class="breadcrumb-item active" href="parametrage">Modifier adresse</span>
                                </nav>
                            </div>
                        </div>
                    </div>
                    ...
                    <br/>
                    <div class="row">
                        <h2 class='title_line <?= !isset($erreurs)?'text-success':'text-danger'?>'><?=isset($resultat)?htmlspecialchars($resultat):'' ?> <?=isset($resultatMdp)?htmlspecialchars($resultatMdp):'' ?></h2>
                    </div> 
                </div>
            </div>
        </div>
						...
						<div class="contact-form-wrap mt--60">
							<div class="col-xs-12">
								<div class="contact-title">
									<h2 class="title__line--6">Modifier une adresse</h2>
								</div>
							</div>
							<div class="col-xs-12">
								<form action="parametrage" method="post">
                                    ...
                                    <input type="hidden" name="id" value="<?=htmlspecialchars($adresse->getId())?>"/>
									
									<div class="contact-btn">
										<button type="submit" class="fv-btn">Modifier</button>
									</div>
								</form>
								<div class="form-output">
									<p class="<?= !isset($erreurs)?'text-success':'text-danger'?>"><?= isset($resultatModAdr)?htmlspecialchars($resultatModAdr):'' ?></p>
								</div>
							</div>
						</div> 
