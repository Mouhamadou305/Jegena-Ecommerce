...
<body>
                            ...
                            <div class="col-md-3 col-lg-2 col-sm-4 col-xs-4">
                                <div class="header__right">
                                    ...
                                    <div class="htc__shopping__cart">
                                        ...
                                        <a class="<?= isset($_SESSION['compte'])?'cart__menu':'' ?>" href="<?= isset($_SESSION['compte'])?'#':'login'?>"><span class="htc__qua"><?=isset($_SESSION['compte'])? $panier->getNombreArticles():0 ?></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            foreach ($listeContenirArticles as $contenirArticle) {?>
                                <div class="shp__single__product">
                                    ...
                                    <div class="remove__btn">
                                        <a href="cart?lien=contact&amp;action=remove&article=<?=htmlspecialchars($contenirArticle->getArticle()->getId()) ?>" title="Remove this item"><i class="zmdi zmdi-close"></i></a>
                                    </div>
                                </div>
                            <?}
                        }?>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-6 col-sm-12 col-xs-12">
                        <h2 class="title__line--6">CONTACTEZ <?=htmlspecialchars($entreprise->getNom()) ?></h2>
                        <div class="address">
                        ...
                        <div class="address">
                            ...
                            <div class="address__details">
                                <h2 class="ct__title">Notre adresse de messagerie</h2>
                                <p><a href="mailto:<?=htmlspecialchars($entreprise->getAdresseMail()) ?>"> <?=htmlspecialchars($entreprise->getAdresseMail()) ?> </a> </p>
                            </div>
                        </div>
                        ...
                        <div class="address">
                            ...
                            <div class="address__details">
                                <h2 class="ct__title">Numéro de téléphone</h2>
                                <p><?=htmlspecialchars($entreprise->getNumeroTelephone1()) ?></p>
                            </div>
                        </div>
                        ...
                        <div class="address">
                            ...
                            <div class="address__details">
                                <h2 class="ct__title">Autre numéro de téléphone</h2>
                                <p><?=htmlspecialchars($entreprise->getNumeroTelephone2()) ?></p>
                            </div>
                        </div>
                    </div>      
                </div>
                    ...
                    <div class="contact-form-wrap mt--60">
                        <div class="col-xs-12">
                            <div class="contact-btn">
                                <a href="mailto:<?=htmlspecialchars($entreprise->getAdresseMail()) ?>" class="fv-btn">ENVOYEZ NOUS UN MAIL</a>
                            </div>
                        </div>
                    </div> 
                </div>
    ...
    <script src="vue/js/contact-map.js"></script>
    <script>
