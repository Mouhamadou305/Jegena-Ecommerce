                            ...
                            foreach ($listeContenirArticles as $contenirArticle) {?>
                                <div class="shp__single__product">
                                    ...
                                    <div class="remove__btn">
                                        <a href="cart?lien=product-details&amp;action=remove&article=<?=htmlspecialchars($contenirArticle->getArticle()->getId()) ?>" title="Remove this item"><i class="zmdi zmdi-close"></i></a>
                                    </div>
                                </div>
                            <?}
                        }?>
                        ...
                        <div class="col-xs-12">
                            <div class="bradcaump__inner">
                                <nav class="bradcaump-inner">
                                  ...
                                  <span class="brd-separetor"><i class="zmdi zmdi-chevron-right"></i></span>
                                  <span class="breadcrumb-item active"><?=htmlspecialchars($article->getNom())?></span>
                                </nav>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                            ...
                            <div class="htc__product__details__tab__content">
                                ...
                                <div class="product__big__images">
                                    <div class="portfolio-full-image tab-content">
                                        ...
                                        <img src=<?=$manager->trouverImage($article)!==null && $manager->trouverImage($article)->getEmplacement()!==null?htmlspecialchars($manager->trouverImage($article)->getEmplacement()):"vue/images/product-2/big-img/1.jpg"?> alt="product images">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-7 col-lg-7 col-sm-12 col-xs-12 smt-40 xmt-40">
                            <div class="ht__product__dtl">
                                ...
                                <p class="pro__info"><?=htmlspecialchars($article->getDescription())?></p>
                                <div class="ht__pro__desc">
                                    <div class="sin__desc">
                                        <p><span>Disponibilité:</span> <?=htmlspecialchars($article->getQuantite())?> unités</p>
                                    </div>
                                    <div class="sin__desc">
                                        <p><span>Taille:</span> <?=htmlspecialchars($article->getTaille())?></p>
                                    </div>    
                                    <div class="sin__desc align--left">
                                        <p><span>Categories:</span></p>
                                        <ul class="pro__cat__list">
                                            <li><a href="product-grid?categorie=<?=htmlspecialchars($article->getCategorie()->getId())?>"><?=htmlspecialchars($article->getCategorie()->getNom())?></a></li>
                                        </ul>
                                    </div>
                                    <br/>
                                    <div class="cr__btn">
                                        <?=!isset($_SESSION['compte'])?'<a href="login">Connectez vous pour accéder au panier et commandez!</a>':$article->getQuantite()>0?'<a href="cart?action=add&amp;article='.htmlspecialchars($article->getId()).'">Ajouter au panier</a>':'Article épuisé' ?>
                                    </div>
