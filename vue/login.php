        ...
        <div class="ht__bradcaump__area" style="background: rgba(0, 0, 0, 0) url(images/bg/4.jpg) no-repeat scroll center center / cover ;">
            <div class="ht__bradcaump__wrap">
                <div class="container">
                        ...
                        <div class="col-xs-12">
                            <div class="bradcaump__inner">
                                <nav class="bradcaump-inner">
                                  ...
                                  <span class="breadcrumb-item active">Connexion/Inscription</span>
                                </nav>
                            </div>
                        </div>
                    </div>
                    ...
                    <br/>
                    <div class="row">
                        <h2 class='title_line text-success'><?=isset($_GET['resultat'])?htmlspecialchars($_GET['resultat']):'' ?><?=isset($resultat)?htmlspecialchars($resultat):'' ?></h2>
                    </div> 
                </div>
            </div>
        </div>
                ...
                <div class="row">
					<div class="col-md-6">
						<div class="contact-form-wrap mt--60">
							...
							<div class="col-xs-12">
								<form id="contact-login-form" action="login" method="post">
									<div class="single-contact-form">
										<div class="contact-box name">
											<input type="text" name="adresseMail" value="<?= isset($compte) && null!==$compte->getAdresseMail()?htmlspecialchars($compte->getAdresseMail()):'' ?>" placeholder="Votre email*" style="width:100%">
										</div>
									</div>
									<div class="single-contact-form">
										<div class="contact-box name">
											<input type="password" name="motDePasse" placeholder="Votre mot de passe*" style="width:100%">
										</div>
									</div>
									...
									<div class="contact-btn">
										<button type="submit" class="fv-btn">Se connecter</button>
									</div>
								</form>
								<div class="form-output">
									<p class="text-danger"><?=isset($erreurs['motDePasseLog'])?$erreurs['motDePasseLog']:'' ?></p>
                                    <p class="text-danger"><?=isset($erreurs['adresseMailLog'])?$erreurs['adresseMailLog']:'' ?></p>
                                    <p class="<?= !isset($erreurs)?'text-success':'text-danger'?>"><?= isset($resultatLog)?htmlspecialchars($resultatLog):'' ?></p>
								</div>
							</div>
						</div> 
					...
					<div class="col-md-6">
						<div class="contact-form-wrap mt--60">
							<div class="col-xs-12">
								<div class="contact-title">
									<h2 class="title__line--6">Inscription</h2>
								</div>
							</div>
							<div class="col-xs-12">
								<form id="contact-register-form" action="login" method="post">
									<div class="single-contact-form">
										<div class="contact-box name">
									...
									<div class="single-contact-form">
                                        ...
                                        <div class="text-danger"><?=isset($erreurs['adresseMail'])?htmlspecialchars($erreurs['adresseMail']):'' ?></div>
									</div>
									<div class="single-contact-form">
										<div class="contact-box name">
                                    ...
                                    <div class="single-contact-form">
										<div class="contact-box name">
											<input type="password" name="confirmation" placeholder="Confirmez votre mot de passe*" style="width:100%">
										</div>
									...
									<div class="contact-btn">
										<button type="submit" class="fv-btn">S'inscrire</button>
									</div>
								</form>
								<div class="form-output">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-6 col-xs-12 xmt-40 smt-40">
                            <div class="footer">
                                ...
                                <div class="ft__inner">
                                    <ul class="social__link">
                                        <li><a href="<?=$entreprise->getTwitter() ?>"><i class="icon-social-twitter icons"></i></a></li>

                                        <li><a href="<?=$entreprise->getInstagram() ?>"><i class="icon-social-instagram icons"></i></a></li>

                                        <li><a href="<?=$entreprise->getFacebook() ?>"><i class="icon-social-facebook icons"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
