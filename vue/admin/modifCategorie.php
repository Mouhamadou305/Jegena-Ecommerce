                     ...
                     <div class="col-lg-12">
                        <div class="card">
                           ...
                           <div class="card-body card-block">
                              ...
                              <div class="alert alert-info text-danger"><?=isset($erreurs) && isset($erreurs['genre'])?htmlspecialchars($erreurs['genre']):'' ?></div><input type="hidden" name="action" value="ajouter">
                              <input type="hidden" name="categorie" value="<?=htmlspecialchars($categorie->getId())?>">
                              <button id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
                              <span id="payment-button-amount">Modifier la catégorie</span>
                              </button>
                           </div>
                        </div>
                     </div>
