                        ...
                        <div class="col-xs-12">
                            <div class="bradcaump__inner">
                                <nav class="bradcaump-inner">
                                  ...
                                  <a href="historiqueCommandes" class="breadcrumb-item">Mes commandes</a>
                                  <span class="brd-separetor"><i class="zmdi zmdi-chevron-right"></i></span>
                                  <span class="breadcrumb-item active">Articles commandés</span>
                                </nav>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <tbody>
                                        ...
                                        <?if(isset($listeArticles) && !empty($listeArticles)){
                                            foreach ($listeArticles as $article) {?>
                                                <tr>
                                                    <td class="product-remove"><a href="product-details?article=<?=htmlspecialchars($article->getArticle()->getId()) ?>"><i class="icon-eye icons"></i></a></td>
                                                    <td class="product-thumbnail"><a href="product-details?article=<?=htmlspecialchars($article->getArticle()->getId()) ?>"><img src="vue/images/product-2/cart-img/1.jpg" alt="product img" /></a></td>
                                                    <td class="product-price"><span class="amount"><?=htmlspecialchars($article->getArticle()->getId())?></span></td>
                                                    <td class="product-price"><span class="amount"><?=htmlspecialchars($article->getArticle()->getNom())?></span></td>
                                                    <td class="product-price"><span class="amount"><?=htmlspecialchars($article->getArticle()->getPrix()-$article->getArticle()->getPrix()*($article->getArticle()->getPourcentageSolde()/100))?> FCFA</span></td>
                                                    <td class="product-price"><span class="amount"><?=htmlspecialchars($article->getArticle()->getTaille())?></span></td>
                                                    <td class="product-price"><span class="amount"><?=htmlspecialchars($article->getNombreArticles())?></span></td>
                                                </tr>
                                            <?}
                                        }?>
                                    </tbody>
